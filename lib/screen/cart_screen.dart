          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                item.optionName.isNotEmpty
                    ? Text(item.optionName.join('/'))
                    : Text("기본"),
                Row(
  ...
  Widget totalPriceWidget() {
    return Column(
      ...
      children: [
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [Text("주문금액"), Text("${cartController.itemTotal}원")],
        ),
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
        ...
        if (!cartController.canOrder)
          Container(
            ...
            child: Text(
              ...
              "최소주문금액까지 ${cartController.minPrice - cartController.itemTotal}원 남았어요\n(최소주문금액 ${cartController.minPrice}원)",
